...
import("stdfaust.lib");
process = os.osc(100)*1+os.osc(100*3)+os.osc(100*5)+os.osc(100*7)+os.osc(100*9)+os.osc(100*11)+os.osc(100*13)+os.osc(100*15)+os.osc(100*17):/(9);
```
